        ...
        static void Main()
        {
            ...
            for (int i = 0; i < numberOfGames; i++)
            {
                ...
                for (int j = 0; j < 3; j++)
                {
                    ...
                    {
                        case "A": firstPlayerHandStrength += 1; break;
                        case "J": firstPlayerHandStrength += 11; break;
                        case "Q": firstPlayerHandStrength += 12; break;
                        case "K": firstPlayerHandStrength += 13; break;
                        case "Z": firstPlayerScore *= 2; break;
                        case "Y": firstPlayerScore -= 200; break;
                        case "X": theXCardDrawnByFirstPlayer = true; break;
                        default: firstPlayerHandStrength += 12 - int.Parse(firstPlayerCard); break;
                    }
                }
                ...
                for (int j = 0; j < 3; j++)
                {
                    ...
                    {
                        case "A": secondPlayerHandStrength += 1; break;
                        case "J": secondPlayerHandStrength += 11; break;
                        case "Q": secondPlayerHandStrength += 12; break;
                        case "K": secondPlayerHandStrength += 13; break;
                        case "Z": secondPlayerScore *= 2; break;
                        case "Y": secondPlayerScore -= 200; break;
                        case "X": theXCardDrawnBySecondPlayer = true; break;
                        default: secondPlayerHandStrength += 12 - int.Parse(secondPlayerCard); break;
                    }
                }
